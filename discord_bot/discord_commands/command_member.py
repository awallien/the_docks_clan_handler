...
from discord_bot.discord_bot_util import DiscordBotCommandMemberOptions as dbcmo, EmbedUtil, RankUtil
...
async def _clan_stats_member(bot: "TheDocksDiscordBot",
    ...
    if not clan_stats:
        await interaction.response.send_message(embed=EmbedUtil.error_embed(msg=f"Member '{member}' not found in the clan system."))
        return
