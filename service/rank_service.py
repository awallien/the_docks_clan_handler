...
from entity import ClanMemberRankEnum
...
class RankService:
    ...
    @classmethod
    def new_member_rank(cls, hiscore_data: Hiscore) -> ClanMemberRankEnum:
    ...
    def get_next_rank(cls, hiscore_data, current_rank, current_joined_date) -> ClanMemberRankEnum:
        ...
        if (current_rank in ClanMemberRankEnum.activeness_ranks() and
            ...
            return cls._get_next_achieve_rank()
        else:
            return current_rank

    @classmethod
    def _can_promote_next_active_rank(cls, joined_date) -> bool:
        """
    ...
    @classmethod
    def _get_next_achieve_rank(cls, hiscore_data) -> ClanMemberRankEnum:
